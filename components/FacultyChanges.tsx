...
export default function FacultyChanges({ 
  ...
  return (
    <div className="bg-white bg-opacity-10 backdrop-blur-lg bg-opacity-10  drop-shadow-lg rounded-2xl p-4 shadow-lg">
      <h3 className="text-xl font-outfit font-medium text-purple-900 mb-4">{title}</h3>
      <div style={{ height: `${height}px` }}>
        <canvas ref={chartRef} role="img" aria-label='Gráfica de impacto en cambios en el profesorado a través de los años'  sr-only aria-hidden="true"></canvas>
      </div>
